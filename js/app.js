 ...
 */
//cardlist will conrain a list of icons for cards
...
//animation are made with animate.css library
function checkOpenCards(){
    if (getClassFromCard(openCards[0]) === getClassFromCard(openCards[1])){
        ...
        openCards.forEach(function(card){
            card.animateCss('bounceOut', function(){
...
function endGame(){
    ...
    //with help of vex library a pop with a message will come up to the screen
    vex.dialog.confirm({
        message: `You just won the game in ${timeCount} seconds with ${stars}/3 star rating. Do you want to play again?`,
...
// load animateCss
// library taken from https://github.com/daneden/animate.css/#usage
$.fn.extend({
